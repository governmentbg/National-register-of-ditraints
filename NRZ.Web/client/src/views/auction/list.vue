  ...
  <v-row>
    <v-col>
      <v-card>
        ...
        <v-card-text>
          <v-tabs v-model="tabs">
            <v-tab>{{ $t("auctions.list.current") }}</v-tab>
            <v-tab>{{ $t("auctions.list.upComing") }}</v-tab>
            <v-tab>{{ $t("auctions.list.past") }}</v-tab>
          </v-tabs>
...
export default class AuctionsList extends Vue {
  ...
  getHeaders(){
    return[
      { text: this.$t('auctions.list.headers.code'), value: "announcement.code" },
      { text: this.$t('auctions.list.headers.announcement'), value: "announcement.title" },
      { text: this.$t('auctions.list.headers.startDate'), value: "startDate", filterable: false },
      { text: this.$t('auctions.list.headers.endDate'), value: "endDate", filterable: false },
      { text: this.$t('auctions.list.headers.startPrice'), value: "startPrice" },
      { text: this.$t('auctions.list.headers.currentPrice'), value: "currentPrice" },
    ];
  }
  ...
  mounted() {
    ...
    http
      .get<Auction>(`${baseUrl}/api/Auctions/future`, Auction, true)
      .then((data: Auction[]) => {
    ...
    http
      .get<Auction>(`${baseUrl}/api/Auctions/ongoing`, Auction, true)
      .then((data: Auction[]) => {
    ...
    http
      .get<Auction>(`${baseUrl}/api/Auctions/finished`, Auction, true)
      .then((data: Auction[]) => {
